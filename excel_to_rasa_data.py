...
def create_rasa_files(nlu_path, domain_path, rule_path,  excel_path):
    ...
    rule_file = open(rule_path, 'w', encoding='utf-8')
    domain_file.write("versin: '3.1'\n\nintents:\n")
    nlu_file.write("version: '3.1'\n\nnlu:\n")
    rule_file.write("version: '3.1'\n\nrules:\n")
...
if __name__ == '__main__':
    ...
    rule_file = "data/rules.yml"
    create_rasa_files(nlu_path, domain_path,rule_file, excel_path)
